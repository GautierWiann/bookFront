...
import { login, logout } from '../reducers/DailyNews/userDaily';
import { removeAllBookmark } from '../reducers/DailyNews/bookmarksDaily';
import { unhideArticles } from '../reducers/DailyNews/hiddenArticlesDaily';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faUser, faXmark, faEye } from '@fortawesome/free-solid-svg-icons';
import { Modal } from 'antd';
import { Link } from 'react-router-dom';
import Moment from 'react-moment';
import styles from '../styles/Daily/Header.module.css';
